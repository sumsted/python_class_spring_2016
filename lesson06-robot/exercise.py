# import the robot_controller.py module
...
# Hit the target!
# outside of the Robot class in the follow block...
if __name__ == '__main__':
    # create an instance of Robot() called my_robot, pass your name and debug True
    # call the functions in my_robot to move the robot to the target
    # call distance in my_robot
    # and blink when finished
    pass

# Run the robot target code again with debug set to False
